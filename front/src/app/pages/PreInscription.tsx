...
export function PreInscription() {
  ...
  const professions = [
    { value: 'medecin', label: 'Médecin', icon: Stethoscope, emoji: '🩺' },
    { value: 'infirmier', label: 'Infirmier(e)', icon: Syringe, emoji: '💉' },
    { value: 'psychologue', label: 'Psychologue', icon: Brain, emoji: '🧠' },
    { value: 'kinesitherapeute', label: 'Kinésithérapeute', icon: Bone, emoji: '🦴' },
  ];
      ...
      <div className="min-h-screen pt-20 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-[#F4F5F7]">
        ...
        >
          ...
          <p className="text-lg text-[#718096] mb-8 leading-relaxed">
            Votre pré-inscription a bien été enregistrée. Notre équipe vous contactera dès l'ouverture 
            officielle de la plateforme pour finaliser votre inscription et configurer votre profil professionnel.
          </p>
          <div className="bg-gradient-to-r from-[#1FBF9A]/10 to-[#6BE3B2]/10 border border-[#1FBF9A]/20 rounded-2xl p-6 mb-8">
            <p className="text-[#718096]">
              Vous recevrez un e-mail de confirmation à l'adresse : <br />
      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          <h1 className="text-4xl sm:text-5xl font-extrabold text-[#1A202C] mb-4">
            Rejoignez OmniCare en avant-première
          </h1>
          <p className="text-xl text-[#718096] leading-relaxed">
            Soyez parmi les premiers professionnels à intégrer notre plateforme
          </p>
        </motion.div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-semibold text-[#1A202C] mb-4">
                Profession <span className="text-[#EF4444]">*</span>
              </label>
          ...
          <div className="mt-8 p-4 bg-[#F4F5F7] rounded-xl">
            <p className="text-sm text-[#718096] text-center leading-relaxed">
              En soumettant ce formulaire, vous acceptez d'être contacté par OmniCare 
              concernant l'ouverture de la plateforme. Vos données sont protégées et ne seront 
